...
*A Multi-Dataset, Reproducible Research Framework using 2D Vision Transformers (ViT), 1D ECG Foundation Models (FM), and Hybrid Feature Alignment.*
...
- *Detecting Chagas Disease Using a Vision Transformer–Based ECG Foundation Model (2025)*  
- *Embedding ECG Signals into 2D Images with Preserved Spatial Information (2025)*  
...
│ │ └── 2d_images/ # structured ECG images (3 × 24 × 2048)
